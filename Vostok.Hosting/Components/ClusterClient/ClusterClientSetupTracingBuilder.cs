...
{
    internal class ClusterClientSetupTracingBuilder : IClusterClientSetupTracingBuilder, IBuilder<TracingConfiguration>
    {
        private Func<Request, TraceContext, Request> additionalRequestTransformation;

        public IClusterClientSetupTracingBuilder SetAdditionalRequestTransformation(Func<Request, TraceContext, Request> additionalRequestTransformation)
        {
