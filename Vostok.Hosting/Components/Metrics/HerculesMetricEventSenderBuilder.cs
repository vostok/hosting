...
{
    internal class HerculesMetricEventSenderBuilder : SwitchableComponent<IVostokHerculesMetricEventSenderBuilder>,
        IVostokHerculesMetricEventSenderBuilder,
        IBuilder<HerculesMetricSender>
    {
